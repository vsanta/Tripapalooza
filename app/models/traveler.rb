class Traveler < ActiveRecord::Base
  ...
  validates_length_of :nick, maximum: 20, allow_nil: true, allow_blank: true,  message: " - should be less than 20 characters"
  ...
  validates_format_of :email, with: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, allow_blank: true, allow_nil: true, message: " - invalid format"
